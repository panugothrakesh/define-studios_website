            ...
            <div className="flex flex-col gap-24">
                <div className="lefttt grid grid-cols-2 justify-between w-screen px-24">
                    ...
                    <div className="right flex justify-end">
                        <Image className="flex justify-end items-end h-[56vw] right-0 w-[38vw] object-cover"src={portfolio} alt="photo" height={100} width={100}/>
                    </div>
                </div>
                <div className="righttt grid grid-cols-2 justify-between w-screen px-24">
                    <div className="right flex justify-start w-full">
                        <Image className="flex justify-end items-end left-0 h-[56vw] w-[38vw] object-cover" src={about} alt="photo" height={100} width={100}/>
                    </div>
                ...
                <div className="lefttt grid grid-cols-2 justify-between w-screen px-24">
                    ...
                    <div className="right flex justify-end">
                        <Image className="flex justify-end items-end right-0 h-[56vw] w-[38vw] object-cover" src={press} alt="photo" height={100} width={100}/>
                    </div>
                </div>
                <div className="righttt grid grid-cols-2 justify-between w-screen px-24">
                    <div className="right flex justify-start">
                        <Image className="flex justify-end items-end left-0 h-[56vw] w-[38vw] object-cover" src={connect} alt="photo" height={100} width={100}/>
                    </div>
                    <div className="left flex flex-col justify-center items-start">
                        <div className="flex flex-col gap-2">
